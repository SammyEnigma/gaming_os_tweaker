...
for /f %%b in ('powershell -noprofile -c "Get-NetAdapter | Select -ExpandProperty NdisVersion | %% { if ($_ -ge 6.85) { return 'SUPPORTED' } else { return 'NOT_SUPPORTED' }; }"') do set "NDIS_POLL_SUPPORTED=%%b"
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Class\%ETHERNET_DEVICE_CLASS_GUID_WITH_KEY%" /v "*UsoIPv4" /t REG_SZ /d 1 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Class\%ETHERNET_DEVICE_CLASS_GUID_WITH_KEY%" /v "*UsoIPv6" /t REG_SZ /d 1 /f
